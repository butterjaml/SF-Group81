...
| #5 Resume Upload | qx/resume-upload | TA resume upload panel, PDF/DOC validation, auto filename overwrite strategy, and metadata persistence in `resume_files.csv` | `mvn -q -DskipTests compile` | Ready for Review |
